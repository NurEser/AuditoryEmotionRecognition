...
def count_speakers_from_duration_file(file_path):
    ...
    # Use a set to keep track of unique speakers
    speakers = set()
    
    for line in lines:
        # Split each line at the comma and strip whitespace
        _, speaker = line.split(',')
...
def main():
    ...
    parser.add_argument('--audio_file', type= str , default= 'exampleaudio.wav')
    parser.add_argument('--duration_file', type=str , default = 'exampleduration.txt')
    ...
    file = args.duration_file
    record = args.audio_file
    ...
    if args.model_type==2:
        ...
        skip_length = 2.5
        fold = args.fold
        args.test_path ='./Test_Models/RAVDE_46'
